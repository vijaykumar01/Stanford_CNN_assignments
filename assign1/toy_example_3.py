...
layer_objects[0].num_units = 4
layer_objects[0].W = np.eye(4, 4)
layer_objects[0].dW = np.zeros_like(layer_objects[0].W)
layer_objects[0].non_linearity = 'None'

#layer 2
layer_objects[1].layer_number = 2
layer_objects[1].num_units = 10
layer_objects[1].W = ((2/np.sqrt(3))*np.random.random((10, 4)))-1/np.sqrt(3)
layer_objects[1].dW = np.zeros_like(layer_objects[1].W)
layer_objects[1].non_linearity = 'Sigmoid'

#layer 3
layer_objects[2].layer_number = 3
layer_objects[2].num_units = 4
layer_objects[2].W = W = ((2/np.sqrt(2))*np.random.random((4, 10)))-1/np.sqrt(2)
...
layer_objects[3].W = W = ((2/np.sqrt(1))*np.random.random((1, 4)))-1/np.sqrt(1)
...
for i in xrange(100000):
    ...
    for layer_id in xrange(num_layers):
        layer_objects[layer_id].W = layer_objects[layer_id].W  - 2*layer_objects[layer_id].dW
